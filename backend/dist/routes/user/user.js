...
userRoutes.delete("/savedpost/:id", user_1.deleteSavedPostController);
userRoutes.post("/profile", user_1.uploadProfilePicController);
userRoutes.post("/banner", user_1.uploadBannerController);
